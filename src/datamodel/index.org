...
|------------------------------------------+----------------------+-------------------+----------------------+---|
| createUser(e: Email, n:Name, s: Session) | s.user.role=admin    | s:session-set     | user created         |   |
|                                          |                      | e:user-set.email  |                      |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| deleteUsers( u:User, s:Session)          | s.user.role=admin    | u:user-set        |                      |   |
|                                          | u.role!=admin        | s:session-set     | user-set decreases   |   |
|                                          | s.user!=user         | u:~session.users  |                      |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| getEmail(u: User, s:Session)             |                      | u:user-set        | email returned       |   |
|                                          |                      | s:session-set     |                      |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| getName(u: User,  s:Session)             |                      | s:session-set     | name returned        |   |
|                                          |                      | u:user-set        |                      |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| getRole(u: User, s:Session)              |                      | s:session-set     | role returned        |   |
|                                          |                      | u:user-set        |                      |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| editEmail(u: User, e:Email, s:Session)   | s.user.role=admin or | u:user-set        | user updted          |   |
|                                          | s.user=u             | s:session-set     |                      |   |
|                                          |                      | e:~user-set.email |                      |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| logOut( s:System, s:session)             |                      | s: session-set    | session removed from |   |
|                                          |                      |                   | session set          |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
...
|                                          |                      |                   | user-set updated     |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
| login(s:system , e:email)                |                      | e:user-set.email  | new session created  |   |
|------------------------------------------+----------------------+-------------------+----------------------+---|
|                                          |                      |                   |                      |   |
