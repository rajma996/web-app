...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_adduser(self):
        ...
        with self.assertRaises(ConstraintError):
            s.add_user(inst1,sessi)
        with self.assertRaises(ConstraintError):
            temp2 = {'name': Name('raj'), 'email': Email('raj@gmail.com') , 'role': Role('admin') }
            inst2 = User(temp2)
            s.add_user(inst2,sessi1)
        with self.assertRaises(ConstraintError):
            temp2 = {'name': Name('raj'), 'email': Email('raj@gmail.com') , 'role': Role('admin') }
            inst2 = User(temp2)
            s.add_user(sessi,inst2)
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_deluser(self):
        ...
        with self.assertRaises(ConstraintError):
            ...
            s.del_user(inst2,sessi1)
        with self.assertRaises(ConstraintError):
            temp2 = {'name': Name('raj'), 'email': Email('raj@gmail.com') , 'role': Role('admin') }
            inst2 = User(temp2)
            User.users.append(inst2)
            s.del_user(inst2,sessi)
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_getuserbyemail(self):
        ...
        s = System()
        Session.session_list.append(sessi)
        a = s.getUserByEmail(Email('john@gmail.com'),sessi)
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_setemail(self):
        ...
        Session.session_list.append(sessi1)
        s = System()
        s.set_email(inst1,Email('johnraj@gmail.com'),sessi) # admin changing
        ...
        s.set_email(inst1,Email('johnsnow@gmail.com'),sessi1) # user changing bakc
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_setemail(self):
        ...
        Session.session_list.append(sessi1)
        s = System()
        s.set_name(inst1,Name('johnraj'),sessi) # admin changing
        self.assertEqual(inst1.get_name(),'johnraj')
        s.set_name(inst1,Name('johnsnow'),sessi1) # user changing bakc
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_showsessions(self):
        ...
        s = System()
        with self.assertRaises(ConstraintError):
            a = s.showSessions(sessi1)
        b = s.showSessions(sessi)
...
def del_session(session,sys):
    ...
    if isinstance(session,Session) and isinstance(sys,System):
        if session in Session.session_list:
            Session.session_list.remove(session)
        else :
            raise ConstraintError('session expired')
    else :
