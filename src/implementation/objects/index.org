...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_adduser(self):
        ...
        self.session_list.append(sessi)
        s = System()
        a = s.show_users(sessi)
        for i in range(0,len(a)):
            self.assertEqual(str(a[i].get_email()),str(self.users[i].get_email()))
            self.assertEqual(str(a[i].get_name()),str(self.users[i].get_name()))
            self.assertEqual(str(a[i].get_role()),str(self.users[i].get_role()))
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_setemail(self):
        ...
        self.users.append(inst)
        self.session_list.append(sessi)
        self.users.append(inst1)
        self.session_list.append(sessi1)
        s = System()
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_showsessions(self):
        ...
        for i in range(0,len(b)):
            self.assertEqual(str(b[i].get_user().get_email()),str(self.session_list[i].get_user().get_email()))
            self.assertEqual(str(b[i].get_user().get_name()),str(self.session_list[i].get_user().get_name()))
            self.assertEqual(str(b[i].get_user().get_role()),str(self.session_list[i].get_user().get_role()))
